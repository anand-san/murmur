...
export default function App() {
  return (
    <>
      <div className="absolute top-0 h-7 w-full z-50" data-tauri-drag-region />
      <Routes>
        <Route index path="/" element={<AiInteractionWindow />} />
        <Route path="/settings" element={<ConfigManagerWindow />} />
        <Route path="/settings/provider/new/:type" element={<ProviderForm />} />
        <Route path="/settings/provider/edit/:id" element={<ProviderForm />} />
